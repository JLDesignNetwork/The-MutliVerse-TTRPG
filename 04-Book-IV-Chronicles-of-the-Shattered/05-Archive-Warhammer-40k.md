# The Infinite Archive: Warhammer 40k

This archive provides conversion baselines for the grimdark universe of Warhammer 40,000 (Wrath & Glory / Dark Heresy variants).

## Core Races / Species
| Species | Recommended Origin Tag | Innate Ability Tags | Notes |
| :--- | :--- | :--- | :--- |
| **Human** | [Origin: Biotic] | [Gear: Versatile] | Baseline imperium citizen. |
| **Transhuman (Astartes)**| [Origin: Biotic] | [Trait: Defense Resistant Toxic], [Trait: Defense Ablative 1] | Biologically engineered. Operates at [System: Power Scale 2] without armor. |
| **Eldar (Aeldari)** | [Origin: Biotic] | [Path Feature: Acrobat], [Path Feature: Psionic] | High Vector approach. |
| **Ork** | [Origin: Biotic] | [Trait: Defense Resistant Kinetic], [Path Feature: Relentless]| Massive Endurance pools. |

### Origin & Innate Tag Permissions
*   **[Origin: Biotic]:** You are a living, biological organism. You require food, water, and oxygen, and are susceptible to organic toxins and diseases.
*   **[Gear: Versatile]:** During character creation, you may select one additional Path Tag or one minor narrative permission.
*   **[Trait: Defense Resistant X]:** You automatically ignore the first stage of trauma applied from your specific element or hazard type (e.g., Toxic, Kinetic).
*   **[Trait: Defense Ablative X]:** You naturally absorb the first X stages of physical trauma in any encounter without degrading your health.
*   **[Path Feature: Acrobat]:** You gain [System: Advantage] on Vector or Force checks made to navigate difficult terrain, climb, or avoid area-of-effect hazards.
*   **[Path Feature: Psionic]:** You have a natural connection to the warp, granting the innate ability to sense other minds or warp anomalies nearby.
*   **[Path Feature: Relentless]:** The first time you would be [Status: Clinical Death] or drop to Trauma Stage 9, you instead remain conscious at Stage 8.

> **Note on Path Tags:** The Recommended Path Tags listed below (such as [Path Feature: Veteran] or [Path Feature: Technician]) are core capabilities. Their full mechanical permissions are detailed in **Book III: The Tag-Permission Registry**.

## Core Archetypes (Classes)
| Archetype | Class Tag Options (Choose 1) | Recommended Path Tags (Choose 2) | Power Scale Baseline | Default Domain | Notes |
| :--- | :--- | :--- | :--- | :--- | :--- |
| **Space Marine Tactical** | [Trait: Defense Ablative 3], [Racial Feature: Astartes Physiology], or [Path Feature: Bolter Discipline] | [Path Feature: Veteran], [Gear: Heavy Weapons] | [System: Power Scale 3] | [Domain: Kinetic] / [Domain: Thermal] | Power Armor grants [System: Power Scale 3] and heavy mitigation. |
| **Tech-Priest** | [Lore: Machine Spirit], [Path Feature: Omnissiah's Blessing], or [Path Feature: Flesh is Weak] | [Path Feature: Technician], [Path Feature: Bionic] | [System: Power Scale 2] | [Domain: Kinetic] / [Domain: Digital] | Interacts with the Machine Spirit (hacking/repair). |
| **Inquisitor** | [Trait: Authority], [Class: Ordo Specialist], or [Lore: Rosette] | [Path Feature: Scholar], [Background: Socialite] | [System: Power Scale 2] | [Domain: Kinetic] / [Domain: Metaphysical]| Extreme [System: Rule of Narrative Authority] within the Imperium. |
| **Commissar** | [Path Feature: Execute], [Path Feature: Inspiring Terror], or [Path Feature: Iron Will] | [Path Feature: Veteran], [Path Feature: Intimidating]| [System: Power Scale 2] | [Domain: Kinetic] | Can execute allies to restore Morale tags. |
| **Imperial Guardsman**| [Path Feature: Squad Tactics], [Path Feature: Hold the Line], or [Path Feature: Meatgrinder Survivor] | [Path Feature: Veteran], [Path Feature: Survivalist] | [System: Power Scale 1] | [Domain: Thermal] (Lasgun) | Cheap gear, reliant on squad tactics. |
| **Sister of Battle**| [Path Feature: Fanatic], [Path Feature: Acts of Faith], or [Lore: Holy Promethium] | [Path Feature: Veteran], [Path Feature: Conduit] | [System: Power Scale 2] | [Domain: Thermal] | Faith acts as a pseudo-[Domain: Metaphysical] defense. |
| **Sanctioned Psyker**| [System: Volatile], [Lore: Warp Conduit], or [Lore: Telepathica] | [Path Feature: Conduit], [Path Feature: Scholar] | [System: Power Scale 2] | [Domain: Metaphysical] | High risk of rolling on the Anomaly Table on a 1. |
